...
public interface MushValues {
	...
	public static final String MUSH_GAME_STOPPED = "mush_game_stopped";

	public static final String MUSH_MISSING_TIME = "mush_missing_time";
	 ...
	 * 
	 * public static final String MUSH_MUSH_ATTACK_TIME =
	 * "mush_mush_attack_time"; public static final String MUSH_MUSH_ATTACK =
	 * "mush_mush_attack";
	 * 
	 * public static final String MUSH_GAME_ACTION_NOT_ALLOWED =
	 * "mush_game_action_not_allowed"; public static final String
	 * MUSH_GAME_ACTION_INVALID_TIME = "mush_game_action_invalid_time";
	 * 
	 * public static final String MUSH_GAME_ACTION_ROLE_REQUIRED =
	 * "mush_game_action_role_required";
	 * 
	 ...
	 * 
	 * public static final String MUSH_PLAYER_DEAD = "mush_player_dead"; public
	 * static final String MUSH_PLAYER_ROLE = "mush_player_role";
	 */
}
